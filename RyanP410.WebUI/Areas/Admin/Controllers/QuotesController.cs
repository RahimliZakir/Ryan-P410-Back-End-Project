...
namespace RyanP410.WebUI.Areas.Admin.Controllers
{
    ...
    public class QuotesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FullName,Profession,Content,File,FileTemp")] QuoteCreateCommand request)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FullName,Profession,Content,File,Id")] QuoteEditCommand request)
        {
